...
<SeeAlso>
  Krok za krokem, jak se připojit k VPN naleznete v [podstránce VPN](start/vpn).
</SeeAlso>
...
<SeeAlso>
  Návod krok za krokem, jak se přihlásit k e-mailu v [podstránce e-mail](start/email).
</SeeAlso>
...
<SeeAlso>
  Více informací k LogBooku naleznete na samostatné [podstránce LogBooku](start/logbook).
</SeeAlso>
...
<SeeAlso>
  Více informací k MyStatu naleznete na samostatné [podstránce MyStatu](start/mystat).
</SeeAlso>
...
<SeeAlso>
  Více informací k Remotto naleznete na samostatné [podstránce Remotta](start/remotto).
</SeeAlso>
