...
### VPN
VPN neboli Virtuální privátní síť je důležitá k připojení k našim systémům. Řada interních systémů není na webu přístupná veřejnosti, proto je třeba mít svůj vlastní přístup do VPN.

<div className="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
  Krok za krokem jak se připojit k VPN naleznete v <a href="zaciname/sintegrum">podstránce VPN</a>.
</div>
