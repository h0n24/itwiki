export const SeeAlso = ({ children }) => (
  <div class="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
    {children}
  </div>
);
...
<SeeAlso>
  Jak uspět v integraci? Více informací v [podstránce integrace](start/sintegrum).
</SeeAlso>
